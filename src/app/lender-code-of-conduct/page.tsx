...
export default function LenderCodeOfConductPage() {
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#FBF8F1_0%,#FFFFFF_25%)] dark:bg-none dark:bg-gray-950">
      ...
      <main className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
        <div className="rounded-2xl border border-[#E6D7B0] bg-white p-6 sm:p-10 dark:bg-gray-900">
          <div className="mb-8 border-b border-gray-100 pb-6 dark:border-gray-800">
            <span className="inline-flex rounded-full border border-[#E4CF98] bg-[#F5F0E0] px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[#9F7F34] dark:border-[#C4A55A]/30 dark:bg-[#C4A55A]/15">
              Lender Standards
            </span>
          ...
          <div className="rounded-xl border border-[#E9DBB8] bg-[#FCF8EE] p-5 sm:p-6 dark:border-[#C4A55A]/30 dark:bg-[#C4A55A]/10">
