...
> = {
  ...
  lender_offer_template: { icon: Gift, iconBg: "bg-[#F5F0E0]", iconColor: "text-[#C4A55A]" },
  auto_match_cooldown_lifted: { icon: Gift, iconBg: "bg-amber-50", iconColor: "text-amber-600" },
